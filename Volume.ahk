;This script's credit goes to Rajat. It is not mine. I merely changed the shortcuts and position.
...
vol_Thick = 7   ; thickness of bar

; If your keyboard has multimedia buttons for Volume, you can
; try changing the below hotkeys to use them by specifying
; Volume_Up, ^Volume_Up, Volume_Down, and ^Volume_Down:
HotKey, !x, vol_MasterUp      ; Win+UpArrow
HotKey, !z, vol_MasterDown
HotKey, +!x, vol_WaveUp       ; Shift+Win+UpArrow
HotKey, +!z, vol_WaveDown
